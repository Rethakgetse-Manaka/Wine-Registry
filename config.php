<?php
    ...
    {
        $statement = $this->connection->prepare("SELECT * FROM Wine JOIN Quality ON Wine.WineID = Quality.WineID");
    ...
    {
        $statement = $this->connection->prepare("SELECT * FROM Wine JOIN Quality ON Wine.WineID = Quality.WineID  ORDER BY  ?");
